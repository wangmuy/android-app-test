...
package com.example.test.tasks.view;
...
import com.example.test.tasks.viewmodel.TasksContract;
import com.example.test.tasks.viewmodel.TasksPresenter;
...
public class TasksFragment extends Fragment implements TasksContract.View {
    ...
    public void setPresenter(@NonNull TasksContract.Presenter presenter) {
        mPresenter = checkNotNull((TasksPresenter) presenter);
    }
...
//        mPresenter.result(requestCode, resultCode);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                mPresenter.loadTasks(false).subscribe();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_clear:
                mPresenter.clearCompletedTasks().subscribe();
                break;
    ...
    TaskItemListener mItemListener = new TaskItemListener() {
        ...
        public void onCompleteTaskClick(Task completedTask) {
            mPresenter.completeTask(completedTask).subscribe();
        }

        @Override
        public void onActivateTaskClick(Task activatedTask) {
            mPresenter.activateTask(activatedTask).subscribe();
        }
    };
